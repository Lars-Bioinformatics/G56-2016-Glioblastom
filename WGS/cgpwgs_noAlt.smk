...
INPUT_BAM = WORK+"G56-2016-Glioblastom/bam_noAlt"
OUTPUT = WORK+"G56-2016-Glioblastom/wgs_out_noAlt"
...
SAMPLES = ["G56-sampleC3_truseq-nano-genome_HGL2LDSXX_S12"]
...
rule all:
    input:
        [expand(OUTPUT+"/finished/SUCCESS_"+CNV_TOOL+"__{tumor}_vs_{normal}.txt", tumor=config[s]["tumor"], normal=config[s]["normal"]) for s in SAMPLES]
