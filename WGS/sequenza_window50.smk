...
base_window = "50" # default is 50 - and used here: https://github.com/mbourgey/EBI_cancer_workshop_CNV
bin_size = "500" # Can be varied

WORK = "/work/sduvarcall/G56-2016-Glioblastom/"
INPUT_BAM = WORK+"bam/"
OUTPUT_SEQZ = WORK+"sequenza_window"+bin_size+"/sequenza_seqz/"
OUTPUT = WORK+"sequenza_window"+bin_size+"/sequenza_bin"+bin_size+"/"
